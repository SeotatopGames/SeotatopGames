// "Jymeer_Cube.h" generated by "Obj2Header.exe" [Version 1.9d] Author: L.Norri Fullsail University.
// Data is converted to left-handed coordinate system and UV data is V flipped for Direct3D/Vulkan.
// The companion file "Jymeer_Cube.h2b" is a binary dump of this format(-padding) for more flexibility.
// Loading *.h2b: read version, sizes, handle strings(max len 260) by reading until null-terminated.
/***********************/
/*  Generator version  */
/***********************/
#ifndef _Jymeer_Cube_version_
const char Jymeer_Cube_version[4] = { '0','1','9','d' };
#define _Jymeer_Cube_version_
#endif
/************************************************/
/*  This section contains the model's size data */
/************************************************/
#ifndef _Jymeer_Cube_vertexcount_
const unsigned Jymeer_Cube_vertexcount = 24;
#define _Jymeer_Cube_vertexcount_
#endif
#ifndef _Jymeer_Cube_indexcount_
const unsigned Jymeer_Cube_indexcount = 36;
#define _Jymeer_Cube_indexcount_
#endif
#ifndef _Jymeer_Cube_materialcount_
const unsigned Jymeer_Cube_materialcount = 1; // can be used for batched draws
#define _Jymeer_Cube_materialcount_
#endif
#ifndef _Jymeer_Cube_meshcount_
const unsigned Jymeer_Cube_meshcount = 1;
#define _Jymeer_Cube_meshcount_
#endif
/************************************************/
...
#define __OBJ_VERT__
#endif
#ifndef _Jymeer_Cube_vertices_
// Raw Vertex Data follows: Positions, Texture Coordinates and Normals.
const OBJ_VERT Jymeer_Cube_vertices[24] =
{
...
#define _Jymeer_Cube_vertices_
#endif
#ifndef _Jymeer_Cube_indices_
// Index Data follows: Sequential by mesh, Every Three Indices == One Triangle.
const unsigned int Jymeer_Cube_indices[36] =
{
	 0, 1, 2,
	 3, 4, 5,
	 6, 7, 8,
...
#endif
#ifndef _Jymeer_Cube_materials_
// Material Data follows: pulled from a .mtl file of the same name if present.
const OBJ_MATERIAL Jymeer_Cube_materials[1] =
{
	{
...
#define _Jymeer_Cube_materials_
#endif
/************************************************/
/*  This section contains the model's structure */
/************************************************/
#ifndef _Jymeer_Cube_batches_
// Use this conveinence array to batch render all geometry by like material.
// Each entry corresponds to the same entry in the materials array above.
// The two numbers provided are the IndexCount and the IndexOffset into the indices array.
// If you need more fine grained control(ex: for transformations) use the OBJ_MESH data below.
const unsigned int Jymeer_Cube_batches[1][2] =
{
	{ 36, 0 },
};
#define _Jymeer_Cube_batches_
#endif
#ifndef __OBJ_MESH__
...
#define __OBJ_MESH__
#endif
#ifndef _Jymeer_Cube_meshes_
// Mesh Data follows: Meshes are .obj groups sorted & split by material.
// Meshes are provided in sequential order, sorted by material first and name second.
const OBJ_MESH Jymeer_Cube_meshes[1] =
{
	{
		"default",
		36,
